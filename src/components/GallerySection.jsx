      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            Discover the range of images showcasing our library's resources and
            facilities.
          </p>
        </motion.div>
                  ...
                  {getVisibleImages().map((image, idx) => (
                    ...
                    >
                      ...
                      >
                        {/* Dark Overlay */}
                        <div
                          className={`absolute inset-0 bg-black/20 bg-gradient-to-t from-black/70 to-transparent transition-opacity duration-300 ${
        ...
        <div className="text-center mt-6 text-gray-600 max-w-2xl mx-auto">
          <p>
            Explore our modern library facilities designed to enhance your
            learning experience.
          </p>
        </div>
      </div>
